...
export const updateDocument = async (roomId: string, title: string) => {
  try {
    ...
    console.log("Error happened while update the room: ", error);
  }
};
...
export const removeCollaborator = async ({
  ...
  try {
    ...
    console.log("Error occured while removing the collaborator: ", error);
  }
};
...
export const deleteDocument = async (roomId: string) => {
  try {
    ...
    console.log("Error occured while deleting the room: ", error);
  }
};
